...
export function RoiCalculator({ language }: RoiCalculatorProps) {
  ...
  return (
    <div id="roi-analysis-calculator-v2" className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
      ...
      <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
        <div className="space-y-6">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="p-1.5 rounded-lg bg-[#A3B18A]/10 text-[#718259] dark:text-[#A3B18A]">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2 p-4 rounded-xl bg-current/[0.012] border border-current/[0.03]">
              <div className="flex justify-between items-center text-xs font-sans">
                <span className="font-medium opacity-80 flex items-center gap-1.5">
                  <UserCheck className="w-3.5 h-3.5 text-[#718259] dark:text-[#A3B18A]" />
                  {dict.employeesCount}
                </span>
                <span className="font-mono font-bold bg-[#A3B18A]/10 px-2 py-0.5 rounded text-[#718259] dark:text-[#A3B18A] text-xs">
                  {employees}
                </span>
              </div>
              <input
                ...
                className="w-full accent-[#718259] bg-gray-200 dark:bg-neutral-800 h-1 rounded-lg appearance-none cursor-pointer"
              />
            ...
            <div className="space-y-2 p-4 rounded-xl bg-current/[0.012] border border-current/[0.03]">
              <div className="flex justify-between items-center text-xs font-sans">
                <span className="font-medium opacity-80 flex items-center gap-1.5">
                  <Receipt className="w-3.5 h-3.5 text-[#718259] dark:text-[#A3B18A]" />
                  {dict.avgSalary}
                </span>
                <span className="font-mono font-bold bg-[#A3B18A]/10 px-2 py-0.5 rounded text-[#718259] dark:text-[#A3B18A] text-xs">
            ...
            <div className="space-y-2 p-4 rounded-xl bg-current/[0.012] border border-current/[0.03]">
              <div className="flex justify-between items-center text-xs font-sans">
                <span className="font-medium opacity-80 flex items-center gap-1.5">
                  <Hourglass className="w-3.5 h-3.5 text-[#718259] dark:text-[#A3B18A]" />
                  {dict.hoursLost}
                </span>
                <span className="font-mono font-bold bg-[#A3B18A]/10 px-2 py-0.5 rounded text-[#718259] dark:text-[#A3B18A] text-xs">
                  {manualHours} t/uge
            ...
            <div className="p-4 rounded-xl bg-current/[0.012] border border-current/[0.03] space-y-4">
              <div className="flex justify-between items-center">
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs text-[#718259] dark:text-[#A3B18A] hover:opacity-100 opacity-80 font-medium cursor-pointer"
                >
                ...
                <span className="text-[10px] font-mono bg-[#10B981]/15 text-[#10B981] px-1.5 py-0.5 rounded font-bold">
        ...
        <div className="p-3.5 rounded-xl bg-current/[0.015] border border-current/[0.04] text-xs font-sans">
          <button
            ...
            className="flex items-center gap-1.5 text-[#718259] dark:text-[#A3B18A] hover:underline font-medium text-[11px] cursor-pointer"
          >
      ...
      <div className="lg:col-span-7 flex flex-col justify-between p-6 bg-white dark:bg-neutral-950 rounded-2xl border border-gray-200 dark:border-neutral-800 shadow-md space-y-6">
        ...
        <div className="border border-current/[0.04] rounded-xl p-4 bg-current/[0.004] dark:bg-neutral-950/20 flex flex-col justify-between relative group">
          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-center text-[11px] font-sans px-1 mb-2.5 gap-2 border-b border-current/[0.03] pb-2">
            <span className="flex items-center gap-1.5 font-medium opacity-80 text-neutral-700 dark:text-neutral-300">
              <BarChart3 className="w-4 h-4 text-[#A3B18A]" />
              {language === 'da' ? 'Interaktiv Gevinstkurve' : 'Interactive Projections & Break-even'}
            </span>
            <span className="text-[9px] font-mono uppercase tracking-wide opacity-50 bg-[#A3B18A]/10 text-[#718259] dark:text-[#A3B18A] px-2 py-0.5 rounded">
          ...
          <div className="w-full h-[180px] relative mt-1 select-none">
            <svg viewBox="0 0 420 180" className="w-full h-full overflow-visible">
              ...
              <text x={scaleX(1)} y="168" fill="currentColor" className={activeYear === 1 ? "font-bold fill-[#718259] dark:fill-[#A3B18A] transition-colors" : "opacity-40"} fontSize="8" fontFamily="sans-serif" textAnchor="middle">År 1</text>
              <text x={scaleX(2)} y="168" fill="currentColor" className={activeYear === 2 ? "font-bold fill-[#718259] dark:fill-[#A3B18A] transition-colors" : "opacity-40"} fontSize="8" fontFamily="sans-serif" textAnchor="middle">År 2</text>
              <text x={scaleX(3)} y="168" fill="currentColor" className={activeYear === 3 ? "font-bold fill-[#718259] dark:fill-[#A3B18A] transition-colors" : "opacity-40"} fontSize="8" fontFamily="sans-serif" textAnchor="middle">År 3</text>
              <text x={scaleX(4)} y="168" fill="currentColor" className={activeYear === 4 ? "font-bold fill-[#718259] dark:fill-[#A3B18A] transition-colors" : "opacity-40"} fontSize="8" fontFamily="sans-serif" textAnchor="middle">År 4</text>
              <text x={scaleX(5)} y="168" fill="currentColor" className={activeYear === 5 ? "font-bold fill-[#718259] dark:fill-[#A3B18A] transition-colors" : "opacity-40"} fontSize="8" fontFamily="sans-serif" textAnchor="middle">År 5</text>
        ...
        >
          <div className="flex justify-between items-center">
            <h4 className="text-xs font-mono font-semibold uppercase tracking-wider text-[#718259] dark:text-[#A3B18A] flex items-center gap-1">
